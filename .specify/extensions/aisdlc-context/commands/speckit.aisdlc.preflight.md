...
7. If the durable context scaffold is missing, explicitly recommend running `__SPECKIT_COMMAND_AISDLC_BOOTSTRAP__` before relying on generic recommendations.
