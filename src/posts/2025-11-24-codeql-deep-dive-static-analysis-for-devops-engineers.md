...
image_alt: "Source code on the left dissolving into a graph of functions and call edges, queried by a panel on the right that returns a single flagged result row."
