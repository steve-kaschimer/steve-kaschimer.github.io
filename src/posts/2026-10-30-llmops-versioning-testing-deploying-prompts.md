...
image_alt: "A versioned file passing an evaluation gate that scores it against the currently deployed version, then a staged rollout dial with a dashed rollback path."
