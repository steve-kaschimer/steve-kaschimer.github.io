...
image_alt: "A three-column exchange where a runner trades a signed claims token for a one-hour cloud token, beside a crossed-out padlock marked no stored secret."
