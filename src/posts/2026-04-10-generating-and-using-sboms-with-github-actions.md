...
image_alt: "A manifest document branching into a tree of package nodes, with one flagged node's path traced back to the root and an attestation seal alongside."
