...
image_alt: "Three rollout stages with progress bars at different levels of completion, beside a grid of repositories where most, but not all, show a green check."
