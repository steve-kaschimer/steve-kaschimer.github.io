...
image_alt: "A JavaScript config object fading out on the left and CSS-native directives sharp on the right, with two benchmark bars below showing a much faster build."
