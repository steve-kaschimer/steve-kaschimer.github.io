...
image_alt: "A hexagonal server node with two tools plugged into it, linked over an authenticated connection to an agent and running inside its own container."
