...
image_alt: "Five security scan lanes running in parallel above a delivery timeline, with a dimmed, crossed-out sequential version of the same pipeline behind them."
