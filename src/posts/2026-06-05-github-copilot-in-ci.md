...
image_alt: "A pull request diff with inline comments from an automated reviewer, and a pipeline stage for it carrying an advisory badge instead of a blocking failure."
