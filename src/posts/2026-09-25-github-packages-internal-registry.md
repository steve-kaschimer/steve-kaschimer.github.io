...
image_alt: "A registry cylinder fed by three package formats, serving two consumers inside an org boundary with a built-in token and one outside that needs its own."
