...
image_alt: "Decision records and a conventions file feeding a rules panel that an agent reads alongside a diff, producing a comment citing the specific rule violated."
