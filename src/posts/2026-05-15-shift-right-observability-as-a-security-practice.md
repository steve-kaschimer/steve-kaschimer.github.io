...
image_alt: "A pre-deploy pipeline on the left joined by an arrow to a live production cluster on the right, where anomaly markers surface in the telemetry."
