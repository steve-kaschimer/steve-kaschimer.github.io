...
image_alt: "A terminal of command-line invocations beside a ghosted browser window crossed out in red, with web UI elements dissolving into the terminal frame."
