...
image_alt: "Five lined-up pull request cards grouped into one batch that runs a single consolidated test pass, with an inset showing a failing card ejected sideways."
