...
date: 2027-02-09
image: /images/posts/2027-02-09-hero.webp
image_alt: "A lowercase lambda glyph flowing into a short chain of connected dots representing a composable list of tests, with a small dice icon nearby for property-based testing."
image_prompt: "A dark-mode technical editorial illustration on a near-black background with electric teal, amber, and off-white accents. Composition centers on a lowercase lambda glyph on the left, connected by a thin teal line to a short horizontal chain of four small connected dots representing a composable list value. Below the chain, a small amber dice-face icon with scattered pips sits slightly apart, connected by a dashed line, representing randomized property-based inputs. Faint bracket marks sit at reduced opacity along the top edge, evoking functional syntax without forming real text. Mood is composable, mathematical, and calm. Avoid: vendor logos, brand colors, circuit-board textures, gears, or generic checkmark/lightbulb clip art."
layout: post.njk
site_title: Tech Notes
summary: "Expecto asks what a test looks like if it's just an ordinary F# value. A setup guide for composing tests as data, setup/teardown via function composition, and property-based testing with FsCheck built in."
...
If you're deciding between testing frameworks first, [a comparison of the top .NET testing frameworks](/posts/2027-01-05-top-5-dotnet-testing-frameworks-compared/) covers where Expecto fits relative to xUnit, NUnit, MSTest, and TUnit - including why it's the right answer specifically for F#, not a competing option for C# projects.
