...
image_alt: "A cracked persistent server carrying state across three consecutive jobs, set against a row of throwaway containers each created and destroyed per job."
