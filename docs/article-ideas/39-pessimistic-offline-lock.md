...
csharp: 14
description: Prevent conflicting long-running business transactions by
  acquiring application-level locks before work begins, with .NET
  examples and database-locking trade-offs.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/pessimisticOfflineLock.html"
order: 39
pattern: Pessimistic Offline Lock
