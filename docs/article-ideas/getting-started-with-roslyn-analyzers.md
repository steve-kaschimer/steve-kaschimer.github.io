...
If you're deciding between architecture/quality tools first, a comparison of the top .NET architecture and quality enforcement tools covers where Roslyn Analyzers fit relative to NetArchTest, ArchUnitNET, SonarQube, and NDepend.
