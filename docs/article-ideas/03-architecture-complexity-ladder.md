...
csharp: 14
description: Learn when a .NET application has earned additional
  architecture, from straightforward CRUD through domain modeling, CQRS,
  messaging, and distributed workflows.
dotnet: 10
order: 3
series: Modern Application Architecture Patterns in .NET
slug: architecture-complexity-ladder
status: draft
