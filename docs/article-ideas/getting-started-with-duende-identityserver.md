...
If you're deciding between auth/identity solutions first, a comparison of the top auth and identity solutions for .NET covers where Duende IdentityServer fits relative to ASP.NET Core Identity, Auth0, Keycloak, and Microsoft Entra External ID.
