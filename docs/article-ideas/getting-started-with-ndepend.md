...
If you're deciding between architecture/quality tools first, a comparison of the top .NET architecture and quality enforcement tools covers where NDepend fits relative to NetArchTest, ArchUnitNET, SonarQube, and Roslyn Analyzers -- including the licensing consideration that sets it apart from every other tool in this series.
