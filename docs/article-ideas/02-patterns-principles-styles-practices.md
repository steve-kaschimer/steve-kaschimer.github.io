...
csharp: 14
description: Separate architectural styles, design patterns, principles,
  practices, and technologies so architecture discussions become about
  decisions rather than labels.
dotnet: 10
order: 2
series: Modern Application Architecture Patterns in .NET
slug: patterns-principles-styles-practices
status: draft
title: "Patterns, Principles, Styles, and Practices: Know What You're
  Choosing"
volume: 2
---
