...
csharp: 14
description: Learn how Identity Map prevents duplicate in-memory
  representations of the same database row and how EF Core tracking
  implements the idea.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/identityMap.html"
order: 14
