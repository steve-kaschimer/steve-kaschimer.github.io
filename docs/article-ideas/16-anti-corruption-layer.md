...
csharp: 14
description: Protect a modern .NET domain from legacy systems, vendor
  APIs, and foreign bounded contexts by translating protocols, data,
  errors, and semantics at an explicit boundary.
dotnet: 10
order: 16
series: Modern Application Architecture Patterns in .NET
slug: anti-corruption-layer
status: draft
title: "Anti-Corruption Layer: Protecting Your Domain From Someone
  Else's Model"
volume: 2
---
