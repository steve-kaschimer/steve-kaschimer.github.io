...
csharp: 14
description: Design DDD aggregates around transactional consistency and
  business invariants instead of object graphs or database
  relationships.
dotnet: 10
order: 12
series: Modern Application Architecture Patterns in .NET
slug: aggregate-aggregate-root
status: draft
