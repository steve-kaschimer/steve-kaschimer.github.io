...
If you're deciding between message brokers first, a comparison of the top .NET message brokers covers where NATS fits relative to RabbitMQ, Kafka, Azure Service Bus, and Amazon SQS.
