...
csharp: 14
description: A practical comparison of three important ways to organize
  business logic in modern .NET applications.
dotnet: 10
order: 3
series: Patterns of Enterprise Application Architecture in Modern .NET
slug: transaction-script-domain-model-service-layer
status: draft
