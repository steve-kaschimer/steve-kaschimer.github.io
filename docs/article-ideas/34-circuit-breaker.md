...
description: "Fail fast when a dependency is persistently unhealthy, allowing recovery while preventing cascading latency, retry storms, and resource exhaustion."
