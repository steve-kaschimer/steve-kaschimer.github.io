...
If you're deciding between message brokers first, a comparison of the top .NET message brokers covers where RabbitMQ fits relative to Kafka, Azure Service Bus, Amazon SQS, and NATS.
