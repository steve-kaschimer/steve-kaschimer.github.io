...
If you're deciding between mocking libraries first, a comparison of the top .NET mocking libraries covers where JustMock fits relative to Moq, NSubstitute, FakeItEasy, and Rocks.
