...
csharp: 14
description: Map many-to-many object relationships through relational
  join tables using EF Core skip navigations and explicit association
  entities.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/associationTableMapping.html"
order: 19
