...
slug: "event-sourcing"
description: "Persist domain changes as an append-only stream of events, rebuild state through replay, and understand projections, snapshots, schema evolution, concurrency, and why most systems should not adopt Event Sourcing casually."
