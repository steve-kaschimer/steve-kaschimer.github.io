...
csharp: 14
description: An introduction to persistence patterns that bridge domain
  objects and relational databases in modern .NET.
dotnet: 10
order: 4
series: Patterns of Enterprise Application Architecture in Modern .NET
slug: data-access-patterns-object-relational-mismatch
status: draft
