...
csharp: 14
description: An introduction to enterprise application architecture
  patterns and how they apply to modern .NET development.
dotnet: 10
order: 1
series: Patterns of Enterprise Application Architecture in Modern .NET
slug: what-are-enterprise-application-architecture-patterns
status: draft
