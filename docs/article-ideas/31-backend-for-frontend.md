...
description: "Give materially different client experiences their own backend boundary for aggregation, orchestration, security, and client-specific contracts without duplicating core business logic."
