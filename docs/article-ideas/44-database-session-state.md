...
csharp: 14
description: Persist session state in a database for durability,
  sharing, querying, and scale-out, while understanding cleanup and
  contention costs.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/databaseSessionState.html"
order: 44
pattern: Database Session State
