...
csharp: 14
description: Model domain operations that require domain knowledge but
  do not naturally belong to one entity or value object, without turning
  services into an anemic-domain dumping ground.
dotnet: 10
order: 13
