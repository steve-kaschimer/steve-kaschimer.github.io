...
csharp: 14
description: "Model domain concepts whose identity and continuity matter
  more than their current attribute values, while protecting invariants
  with ordinary modern C#."
dotnet: 10
order: 11
