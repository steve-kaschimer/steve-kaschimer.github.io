...
csharp: 14
description: "Volume II begins where Patterns of Enterprise Application
  Architecture leaves off: the network, cloud, messaging, DDD, CQRS,
  resilience, and feature-oriented architecture changed the problems we
  routinely solve."
dotnet: 10
order: 1
series: Modern Application Architecture Patterns in .NET
slug: modern-dotnet-architecture-after-poeaa
status: draft
