...
If you're deciding between auth/identity solutions first, a comparison of the top auth and identity solutions for .NET covers where Microsoft Entra External ID fits relative to ASP.NET Core Identity, Duende IdentityServer, Auth0, and Keycloak.
