...
- Commercial licensing for the full feature set, unlike Redis's more permissive open-source core (before considering Redis's own recent licensing changes)
