...
csharp: 14
description: Use Razor as a modern Template View, separating
  presentation markup from application behavior with strongly typed view
  models, layouts, and partials.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/templateView.html"
order: 32
