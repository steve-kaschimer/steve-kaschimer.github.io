...
If you're deciding between caching options first, a comparison of the top .NET caching solutions covers where `IMemoryCache` fits relative to Redis, NCache, Memcached, and Garnet.
