...
For a broader look at how Serilog stacks up against the alternatives, a comparison of the top .NET logging frameworks covers where it fits relative to NLog, log4net, and the rest.
