...
csharp: 14
description: Use dependency injection as an architectural composition
  technique in modern .NET, with explicit dependencies, correct
  lifetimes, keyed services, factories, decorators, and a disciplined
  composition root.
dotnet: 10
order: 6
