...
csharp: 14
description: Design a .NET application around use-case ports and
  replaceable adapters so HTTP, databases, brokers, and external APIs
  remain outside the application core.
dotnet: 10
order: 8
