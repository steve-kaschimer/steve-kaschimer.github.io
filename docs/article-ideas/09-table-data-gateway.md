...
csharp: 14
description: Use Table Data Gateway to isolate SQL and table-oriented
  persistence behind a focused API in modern .NET.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/tableDataGateway.html"
order: 9
