...
If you want a broader comparison of logging options before committing to log4net specifically, it's worth reading a general .NET logging overview first so you know how log4net fits alongside NLog and Serilog.
