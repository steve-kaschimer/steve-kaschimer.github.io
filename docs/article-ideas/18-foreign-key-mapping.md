...
csharp: 14
description: "Map object references and collections to relational
  foreign keys using modern EF Core relationship configuration and
  domain-friendly C# models."
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/foreignKeyMapping.html"
order: 18
