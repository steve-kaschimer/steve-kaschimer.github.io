...
If you're deciding between auth/identity solutions first, a comparison of the top auth and identity solutions for .NET covers where Auth0 fits relative to ASP.NET Core Identity, Duende IdentityServer, Keycloak, and Microsoft Entra External ID.
