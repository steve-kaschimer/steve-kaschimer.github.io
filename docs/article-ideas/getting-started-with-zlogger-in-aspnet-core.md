...
If you're not sure ZLogger is the right fit yet, a comparison of the top .NET logging frameworks walks through when its performance trade-offs are worth the smaller ecosystem.
