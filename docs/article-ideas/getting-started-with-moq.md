...
If you're deciding between mocking libraries first, a comparison of the top .NET mocking libraries covers where Moq fits relative to NSubstitute, FakeItEasy, JustMock, and Rocks -- including the fuller context on SponsorLink.
