...
If you're deciding between caching options first, a comparison of the top .NET caching solutions covers where Memcached fits relative to `IMemoryCache`, Redis, NCache, and Garnet.
