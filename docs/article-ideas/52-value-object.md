...
csharp: 14
description: "Model concepts by their values rather than identity using
  immutable C# records, readonly record structs, validation, equality,
  and EF Core complex types."
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/valueObject.html"
order: 52
