...
If you're deciding between message brokers first, a comparison of the top .NET message brokers covers where Amazon SQS fits relative to RabbitMQ, Kafka, Azure Service Bus, and NATS.
