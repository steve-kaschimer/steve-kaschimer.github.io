...
csharp: 14
description: Make concurrency protection automatic so application
  developers cannot accidentally bypass optimistic or pessimistic
  locking rules.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/implicitLock.html"
order: 41
pattern: Implicit Lock
