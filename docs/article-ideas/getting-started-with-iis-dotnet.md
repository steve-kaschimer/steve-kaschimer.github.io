...
If you're deciding between deployment options first, a comparison of the top ways to deploy .NET apps covers where IIS fits relative to Docker + Kubernetes, Azure Container Apps, AWS ECS/Fargate, and .NET Aspire's deploy workflow.
