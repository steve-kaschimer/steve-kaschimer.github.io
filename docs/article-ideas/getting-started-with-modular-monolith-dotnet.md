...
If you're deciding between architecture styles first, a comparison of the top .NET architecture patterns covers where Modular Monolith fits relative to layered architecture, Clean Architecture, Vertical Slice, and Microservices.
