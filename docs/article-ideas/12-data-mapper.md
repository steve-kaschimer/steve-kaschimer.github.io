...
csharp: 14
description: Learn how Data Mapper separates domain objects from
  persistence and why EF Core makes the pattern central to modern .NET
  architecture.
dotnet: 10
fowler_url: "https://martinfowler.com/eaaCatalog/dataMapper.html"
order: 12
pattern: Data Mapper
