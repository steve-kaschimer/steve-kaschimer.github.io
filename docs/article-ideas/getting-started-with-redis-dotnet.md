...
If you're deciding between caching options first, a comparison of the top .NET caching solutions covers where Redis fits relative to `IMemoryCache`, NCache, Memcached, and Garnet.
