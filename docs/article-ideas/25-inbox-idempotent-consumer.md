...
slug: "inbox-idempotent-consumer"
description: "Detect and safely ignore duplicate message deliveries by persisting consumed message identity with business effects in one local transaction."
