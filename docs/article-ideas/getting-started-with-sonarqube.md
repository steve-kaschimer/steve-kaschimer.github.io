...
If you're deciding between architecture/quality tools first, a comparison of the top .NET architecture and quality enforcement tools covers where SonarQube fits relative to NetArchTest, ArchUnitNET, Roslyn Analyzers, and NDepend.
