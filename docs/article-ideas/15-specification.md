...
csharp: 14
description: Encapsulate reusable business predicates and composable
  selection rules without turning every LINQ expression into an
  abstraction or coupling the domain to persistence mechanics.
dotnet: 10
order: 15
