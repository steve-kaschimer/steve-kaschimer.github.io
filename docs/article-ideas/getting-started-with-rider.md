...
If you're deciding between .NET IDEs and editors first, a comparison of the top .NET IDEs and editors covers where Rider fits relative to Visual Studio, VS Code, Cursor, and Neovim.
