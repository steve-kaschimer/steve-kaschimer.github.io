...
description: "Persist integration messages in the same local transaction as business state, then publish them asynchronously with at-least-once delivery and observable retry semantics."
