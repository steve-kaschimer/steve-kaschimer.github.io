...
If you're deciding between caching options first, a comparison of the top .NET caching solutions covers where NCache fits relative to `IMemoryCache`, Redis, Memcached, and Garnet.
